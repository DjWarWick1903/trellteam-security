package ro.trellteam.security.config;
...
import ro.trellteam.security.filter.CustomAuthenticationFilter;
import ro.trellteam.security.filter.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(Arrays.asList("http://localhost:63342", "http://localhost:63343"));
